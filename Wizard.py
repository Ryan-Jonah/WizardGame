...
while not(gameExit):
	...
	for event in pygame.event.get():
		...
		#CHECK ATTACK EVENT AND DIRECTION
	...
	#UI
	songText = text.render("Song: Silent Night" , True, YELLOW, DARKBLUE)
	fpsText = text.render("Fps: {0}".format(fps), True, YELLOW, DARKBLUE)
	controlsText = text.render("WASD + Mouse" , True, WHITE)
	gameDisplay.blit(songText ,(5, 5))
	gameDisplay.blit(fpsText,(5, 25))
	gameDisplay.blit(controlsText,(5,  display_height-15))
